...
aut aut aut maxime quia temporibus ut omnis`}],Dc=Tc.map(e=>({...e,user:Mc.find(t=>t.id===e.userId),comments:Rc.filter(t=>t.postId===e.id)})),jc=()=>V.jsxs("section",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Lc,{posts:Dc})]});em(document.getElementById("root")).render(V.jsx(jc,{}));
